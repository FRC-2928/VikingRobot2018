...
public class OperatorInterface {
    ...
    public static JoystickButton Flipper = new JoystickButton(operatorConsole, 5);
    ...
    OperatorInterface() {
        ...
        Flipper.whenPressed(new Shoot());
        ShooterUp.whileHeld(new RunLifter(0.4));
        ShooterDown.whileHeld(new RunLifter(-0.4));
