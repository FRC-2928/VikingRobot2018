...
public class RobotMap {
    ...
    public static final int TALON_SHOOTER_RIGHT = 1;
    public static final int TALON_INTAKE = 2;

    // SOLENOID
    public static final int SOLENOID_TRANSMISSION = 0;
    public static final int SOLENOID_TOMAHAWK = 1;
    public static final int SOLENOID_FLIPPER = 7;
